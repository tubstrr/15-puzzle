<template>
  <div id="app">
    <button class="hamburger hamburger--squeeze" :class="{'is-active': ham}" type="button" @click="ham = !ham">
      ...
      <div class="solve" v-if="solved"><span>SOLVED!</span></div>
    ...
    <div class="buttons" :class="{showing:ham}">
      ...
      <button class="scrmble" @click="colors = !colors, ham = !ham">Turn tile colors <span v-if="colors">off</span> <span v-else>on</span></button>
    </div>
  </div>
</template>
